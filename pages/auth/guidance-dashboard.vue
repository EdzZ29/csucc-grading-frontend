            ...
            <div
              ...
              <div class="relative z-10 max-w-lg">
                ...
                <p class="text-green-100 text-lg leading-relaxed">
                  Monitor student academic progress and oversee institutional performance metrics.
                </p>
              </div>
              <div
          ...
          <div>
            ...
            <div class="grid grid-cols-1 gap-6">
              <div
                ...
                <div>
                  <p class="text-sm font-bold text-gray-400 uppercase tracking-wider mb-2">Total Class Records</p>
                  <h4 class="text-5xl font-bold text-green-900 group-hover:text-green-700 transition-colors">{{
                    masterlistsCount }}</h4>
                  <p class="text-sm text-gray-500 mt-2">Classes available for academic monitoring</p>
                </div>
                <div
...
export default {
  ...
  methods: {
    async fetchStats() {
      try {
        // ✅ Call new endpoint for unique count
